...
<body>
	<div class="fix maincontent">
		<div class="content">
			...
			<form action="adminAddBloodDonation.php" method="GET">
			...
			<a href="http://www.motivationgroupbd.org/adminHomeBloodDonation.php"><button>Cancel</button></a>
	...
	if($_GET['submit']){
		...
		if($dn!="" && $di!="" && $bg!="" && $dl!="" && $rn!="" && $ra!=""){
			...
			if($data){
				...
				?>
					<META HTTP-EQUIV="Refresh" CONTENT="1 URL=http://www.motivationgroupbd.org/adminHomeBloodDonation.php">
				<?php
