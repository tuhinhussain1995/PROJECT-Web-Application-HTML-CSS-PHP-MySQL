...
<head>
	<meta charset="utf-8">
	<title>Blood Donor Login Page</title>
...
<?php
	...
	if(isset($_POST['submit'])){
		$user = $_POST['username'];
		$pwd = $_POST['password'];
		$query = "select * from blood_donor where user_name='$user' && password='$pwd'";
		...
		if($totalRow == 1){
			...
			header('location:http://www.motivationgroupbd.org/donorHome.php');
		}
		else{
			echo "Login Failed.";
		}
