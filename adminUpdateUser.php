	...
	<div class="fix maincontent">
		<div class="content">
			...
			<form action="adminUpdateUser.php" method="GET">
				...
				<h2><strong>User Update</strong></h2><br><hr><br>
				...
				<p>Phone No:</p>
				<input type="text" name="phone_no" class="inputSize" onkeypress="isInputNumber(event)" required maxlength="14" value="<?php 
					$myString = $_GET['ph'];
					$myString[0] = '+';
					echo $myString; 
				?>"><br><br>
			...
			<a href="http://www.motivationgroupbd.org/adminHomeUser.php"><button>Cancel</button></a>
...
<?php
	...
	if($_GET['submit']){
		...
		$query = "update user set full_name='$fn', father='$fa', mother='$mo', user_name='$un', password='$ps', age='$ag', gender='$gn', profession='$pf', education='$ed', permanent_address='$pe', present_address='$pr', phone_no='$ph', blood_group='$bg', religion='$re', weight='$we', nationality='$na', registration_date='$rd', account_status='$as' where id='$id'";
		...
		if($data){
			...
			?>
				<META HTTP-EQUIV="Refresh" CONTENT="1 URL=http://www.motivationgroupbd.org/adminHomeUser.php">
			<?php

		}
		else{
			echo "<h1>Record not Updated. <a href='adminHomeUser.php'>Check update list here</a></h1>";
		}
