...
<body>
	<div class="fix maincontent">
		<div class="content">
			...
			<form action="adminUpdateMember.php" method="GET">

				<h2><strong>Members Update</strong></h2><br><hr><br>
			...
			<a href="http://www.motivationgroupbd.org/adminHomeMember.php"><button>Cancel</button></a>
...
<?php
	...
	if($_GET['submit']){
		...
		$queryId = "select id from member where user_name='$un'";
		...
		$query = "update member set full_name='$fn', father='$fa', mother='$mo', user_name='$un', password='$ps', age='$ag', gender='$gn', profession='$pf', education='$ed', permanent_address='$pe', present_address='$pr', phone_no='$ph', blood_group='$bg', religion='$re', weight='$we', nationality='$na', registration_date='$rd', account_status='$as' where id='$id'";
		...
		if($data){
			...
			echo "<h1>Record not Updated. <a href='adminHomeMember.php'>Check update list here</a></h1>";
		}
