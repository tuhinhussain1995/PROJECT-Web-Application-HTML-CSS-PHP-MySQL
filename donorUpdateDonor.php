...
<body>
	<div class="fix maincontent">
		<div class="content">
			...
			<form action="donorUpdateDonor.php" method="GET">
			...
			<a href="http://www.motivationgroupbd.org/donorHome.php"><button>Cancel</button></a>
...
<?php
	...
	if($_GET['submit']){
		...
		$query = "update blood_donor set full_name='$fn', father='$fa', mother='$mo', user_name='$un', password='$ps', age='$ag', gender='$gn', profession='$pf', education='$ed', permanent_address='$pe', present_address='$pr', phone_no='$ph', blood_group='$bg', religion='$re', weight='$we', nationality='$na' where id= '$id'";
		...
		if($data){
			...
			?>
				<META HTTP-EQUIV="Refresh" CONTENT="1 URL=http://www.motivationgroupbd.org/donorHome.php">
			<?php

		}
		else{
			echo "<h1>Record not Updated. <a href='donorHome.php'>Check update list here</a></h1>";
		}
