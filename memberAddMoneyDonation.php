...
<body>
	<div class="fix maincontent">
		<div class="content">
			...
			<form action="memberAddMoneyDonation.php" method="GET">
				...
				<p>User ID:</p>
				<input type="text" name="user_id" class="inputSize" onkeypress="isInputNumber(event)" placeholder="Please Enter registered user id"><br><br>
			...
			<a href="http://www.motivationgroupbd.org/memberHomeMoneyDonation.php"><button>Cancel</button></a>
	...
	if($_GET['submit']){
		...
		if($un!="" && $ui!="" && $am!=""){
			...
			if($data){
				...
				?>
					<META HTTP-EQUIV="Refresh" CONTENT="1 URL=http://www.motivationgroupbd.org/memberHomeMoneyDonation.php">
				<?php
