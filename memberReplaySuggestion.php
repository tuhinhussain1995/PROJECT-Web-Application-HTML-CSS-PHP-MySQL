...
<body>
	<div class="fix maincontent">
		<div class="content">
			...
			<form action="memberReplaySuggestion.php" method="GET">
			...
			<a href="http://www.motivationgroupbd.org/memberHomeUserSuggestion.php"><button>Cancel</button></a>
...
<?php
	...
	if($_GET['submit']){
		...
		if($data){
			...
			?>
				<META HTTP-EQUIV="Refresh" CONTENT="1 URL=http://www.motivationgroupbd.org/memberHomeUserSuggestion.php">
			<?php
